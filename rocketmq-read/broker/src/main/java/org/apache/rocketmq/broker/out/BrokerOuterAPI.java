...
public class BrokerOuterAPI {
    ...
    /**
     * 从nameServer服务器寻找地址,当nameServerAddr为null时从http端点获取nameServer地址
     * @return ;
     */
     ...
     * @param backUpBrokerAddr 客户端备用的Broker地址
     * @param brokerName brokerName
     * @param brokerId brokerId
     * @param haServerAddr haServerAddr
     * @param topicConfigWrapper topicConfigWapper
    ...
    public List<RegisterBrokerResult> registerBrokerAll(
        ...
        if (nameServerAddressList != null && nameServerAddressList.size() > 0) {
            ...
            requestHeader.setBackUpBrokerAddr(backUpBrokerAddr);
     ...
     * @param brokerName brokerName
     * @param brokerId brokerId
     * @param topicConfigWrapper topic的configWaper
